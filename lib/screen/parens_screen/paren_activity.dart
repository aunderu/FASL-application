...
class ParenActivityScreen extends StatefulWidget {
  const ParenActivityScreen({super.key});

  @override
  State<ParenActivityScreen> createState() => _ParenActivityScreenState();
}

class _ParenActivityScreenState extends State<ParenActivityScreen> {
  int? id;
  String? fname;
  String? lname;
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(context,
                                        ...
                                        return ParenActivityStudentScreen(
