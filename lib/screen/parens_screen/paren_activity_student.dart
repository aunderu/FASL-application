...
// import 'package:myappv2/screen/class_screen/ParenActivityStudentScreen.dart';
...
class ParenActivityStudentScreen extends StatefulWidget {
  final String idstudent;
  final String fnamestudent;
  final String lnamestudent;
  const ParenActivityStudentScreen(
      this.idstudent, this.fnamestudent, this.lnamestudent,
      {super.key});

  @override
  State<ParenActivityStudentScreen> createState() =>
      _ParenActivityStudentScreenState();
}

class _ParenActivityStudentScreenState
    extends State<ParenActivityStudentScreen> {
  int? id;
  String? fname;
  String? lname;
  void initState() {
  ...
  Future<List<Object>> fetchJSON() async {
    ...
    var jsonResponse = await http.get(
        Uri.parse('https://fasl.chabafarm.com/api/student/activity/$idstu'));
