...
// import 'package:myappv2/screen/class_screen/ParenGradeScreen.dart';
...
import 'package:myappv2/screen/parens_screen/paren_grade_student.dart';
...
class ParenGradeScreen extends StatefulWidget {
  const ParenGradeScreen({super.key});

  @override
  State<ParenGradeScreen> createState() => _ParenGradeScreenState();
}

class _ParenGradeScreenState extends State<ParenGradeScreen> {
  int? id;
  String? fname;
  String? lname;
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(context,
                                        ...
                                        return ParenGradeStudentScreen(
