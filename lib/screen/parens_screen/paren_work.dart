...
// import 'package:myappv2/screen/class_screen/ParenWorkScreen.dart';
...
class ParenWorkScreen extends StatefulWidget {
  const ParenWorkScreen({super.key});

  @override
  State<ParenWorkScreen> createState() => _ParenWorkScreenState();
}

class _ParenWorkScreenState extends State<ParenWorkScreen> {
  int? id;
  String? fname;
  String? lname;
